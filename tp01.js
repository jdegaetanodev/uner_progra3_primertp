...
const modificarArrays = async () => {
    try {
        ...
        personajes.push({ id: 100, fullName: "Personaje Final", title: "The Last One" });
        // 2.b) Agregar al inicio
        personajes.unshift({ id: 101, fullName: "Personaje Inicial", title: "The First One" });
...
const eliminarYFiltrar = async () => {
    try {
        ...
        await fs.writeFile('personajes_filtrados.json', JSON.stringify(simplificados, null, 2));
